...
export const pt: Dictionary = {
  ...
  "verification.documentList.empty": "Nenhum documento registrado.",
  "verification.documentList.open": "Abrir",
  "verification.documentList.delete": "Excluir",
  "verification.documentList.deleteTitle": "Excluir documento",
  "verification.documentList.deleteConfirm":
    "Tem certeza de que deseja excluir este documento?",
  "verification.documentList.deleting": "Excluindo…",
  "verification.documentViewer.zoomOut": "Diminuir zoom",
  "verification.documentViewer.zoomIn": "Aumentar zoom",
  "verification.documentViewer.resetZoom": "Redefinir zoom",
  "verification.documentViewer.cannotPreview": "não pode ser pré-visualizado aqui.",
  "verification.documentViewer.openInNewTab": "Abrir em uma nova aba",
  ...
  "markets.tabs.allShort": "Todas",
  "markets.tabs.popularShort": "Populares",
  "markets.tabs.gainersShort": "Subidas",
  "markets.tabs.losersShort": "Descidas",
