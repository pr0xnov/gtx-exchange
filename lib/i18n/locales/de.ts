...
export const de: Dictionary = {
  ...
  "verification.documentList.empty": "Keine Dokumente vorhanden.",
  "verification.documentList.open": "Öffnen",
  "verification.documentList.delete": "Löschen",
  "verification.documentList.deleteTitle": "Dokument löschen",
  "verification.documentList.deleteConfirm":
    "Möchten Sie dieses Dokument wirklich löschen?",
  "verification.documentList.deleting": "Wird gelöscht…",
  "verification.documentViewer.zoomOut": "Verkleinern",
  "verification.documentViewer.zoomIn": "Vergrößern",
  "verification.documentViewer.resetZoom": "Zoom zurücksetzen",
  "verification.documentViewer.cannotPreview": "kann hier nicht angezeigt werden.",
  "verification.documentViewer.openInNewTab": "In neuem Tab öffnen",
  ...
  "trading.watchlist.selectPair": "Paar auswählen",
  ...
  "markets.tabs.allShort": "Alle",
  "markets.tabs.popularShort": "Beliebt",
  "markets.tabs.gainersShort": "Gewinner",
  "markets.tabs.losersShort": "Verlierer",
