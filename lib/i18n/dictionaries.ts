...
const en = {
  ...
  // News
  "news.seo.title": "Crypto News | GTX",
  "news.seo.description":
    "The latest Bitcoin, Ethereum, blockchain, and crypto market news on GTX.",
  "news.hero.headingLine1": "Crypto market",
  "news.hero.headingLine2": "news",
  "news.hero.description":
    "The biggest Bitcoin, Ethereum, altcoin, blockchain, and digital asset industry stories — in one place.",
  "news.hero.liveIndicator": "Updates automatically",
  "news.category.all": "All",
  "news.category.bitcoin": "Bitcoin",
  "news.category.ethereum": "Ethereum",
  "news.category.altcoins": "Altcoins",
  "news.category.defi": "DeFi",
  "news.category.regulation": "Regulation",
  "news.sourceFilter.all": "All sources",
  "news.search.placeholder": "Search news",
  "news.featured.readMore": "Read the story",
  ...
  "news.empty.description": "Try changing your search or filters.",
  "news.error.title": "Couldn't load news",
  "news.error.description": "Please try refreshing the page in a little while.",
...
const ru: Dictionary = {
  ...
  "news.seo.title": "Новости криптовалют | GTX",
  "news.seo.description":
    "Последние новости Bitcoin, Ethereum, блокчейна и криптовалютного рынка на GTX.",
  "news.hero.headingLine1": "Новости криптовалютного",
  "news.hero.headingLine2": "рынка",
  "news.hero.description":
    "Главные события Bitcoin, Ethereum, альткоинов, блокчейна и индустрии цифровых активов — в одном месте.",
  "news.hero.liveIndicator": "Обновляется автоматически",
  "news.category.all": "Все",
  "news.category.bitcoin": "Bitcoin",
  "news.category.ethereum": "Ethereum",
  "news.category.altcoins": "Альткоины",
  "news.category.defi": "DeFi",
  "news.category.regulation": "Регулирование",
  "news.sourceFilter.all": "Все источники",
  "news.search.placeholder": "Поиск новостей",
  "news.featured.readMore": "Читать новость",
  "news.latest.title": "Последние новости",
  "news.card.readMore": "Читать больше",
  ...
  "news.empty.title": "Новости не найдены",
  "news.empty.description": "Попробуйте изменить поиск или фильтры.",
  "news.error.title": "Не удалось загрузить новости",
  "news.error.description": "Попробуйте обновить страницу немного позже.",
...
const uk: Dictionary = {
  ...
  "news.seo.title": "Новини криптовалют | GTX",
  "news.seo.description":
    "Останні новини Bitcoin, Ethereum, блокчейну та криптовалютного ринку на GTX.",
  "news.hero.headingLine1": "Новини криптовалютного",
  "news.hero.headingLine2": "ринку",
  "news.hero.description":
    "Головні події Bitcoin, Ethereum, альткоїнів, блокчейну та індустрії цифрових активів — в одному місці.",
  "news.hero.liveIndicator": "Оновлюється автоматично",
  "news.category.all": "Усі",
  "news.category.bitcoin": "Bitcoin",
  "news.category.ethereum": "Ethereum",
  "news.category.altcoins": "Альткоїни",
  "news.category.defi": "DeFi",
  "news.category.regulation": "Регулювання",
  "news.sourceFilter.all": "Усі джерела",
  "news.search.placeholder": "Пошук новин",
  "news.featured.readMore": "Читати новину",
  "news.latest.title": "Останні новини",
  "news.card.readMore": "Читати більше",
  "news.loadMore": "Показати ще",
  "news.time.justNow": "Щойно",
  "news.time.minutesAgo": "хв тому",
  "news.time.hoursAgo": "год тому",
  "news.time.yesterday": "Вчора",
  "news.empty.title": "Новин не знайдено",
  "news.empty.description": "Спробуйте змінити параметри пошуку або фільтри.",
  "news.error.title": "Не вдалося завантажити новини",
  "news.error.description": "Спробуйте оновити сторінку трохи пізніше.",
